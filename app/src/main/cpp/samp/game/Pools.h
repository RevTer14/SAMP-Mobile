...
class CPools {
public:
    static inline CPool<uintptr_t>*            ms_pPtrNodeSingleLinkPool;
    static inline CPool<uintptr_t>*            ms_pPtrNodeDoubleLinkPool;
    static inline CPool<uintptr_t>*              ms_pPedPool;
    static inline CPool<uintptr_t>*            ms_pVehiclePool;
    static inline CPool<uintptr_t>*         ms_pObjectPool;
    static inline CPool<uintptr_t>*         ms_pTaskPool;
    static inline CPool<uintptr_t>*                ms_pEntryInfoNodePool;
    static inline CPool<uintptr_t>*                        ms_pDummyPool;
    static inline CPool<uintptr_t>*                     ms_pBuildingPool;
