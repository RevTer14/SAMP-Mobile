...
void CPools::Initialise()
{
    ...
    CPools::ms_pPtrNodeSingleLinkPool   = new CPool<uintptr_t>(100000, "PtrNode Single");
    CPools::ms_pPtrNodeDoubleLinkPool   = new CPool<uintptr_t>(60000, "PtrNode Double");
    CPools::ms_pPedPool                 = new CPool<uintptr_t>(240, "Peds");
    CPools::ms_pVehiclePool             = new CPool<uintptr_t>(2000, "Vehicles");
    CPools::ms_pObjectPool              = new CPool<uintptr_t>(3000, "Objects");
    CPools::ms_pTaskPool                = new CPool<uintptr_t>(6000, "Task");
    CPools::ms_pEntryInfoNodePool       = new CPool<uintptr_t>(20000, "EntryInfoNodePool");
    CPools::ms_pDummyPool               = new CPool<uintptr_t>(40000, "Dummies");
    CPools::ms_pBuildingPool            = new CPool<uintptr_t>(20000, "Buildings");
